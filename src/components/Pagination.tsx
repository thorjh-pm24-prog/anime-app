    ...
    <div className="flex flex-col items-center gap-4 py-8">
      ...
      <nav className="flex gap-2 flex-wrap justify-center" aria-label="Pagination">
        <button
          ...
          className="px-4 py-2.5 border border-gray-300 bg-white text-gray-700 rounded-lg font-semibold hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed hover:shadow-sm transition-all hover:-translate-y-0.5 active:translate-y-0"
          ...
          <button
            ...
            className={`px-4 py-2.5 min-w-12 rounded-lg font-semibold transition-all shadow-sm ${
              currentPage === page
                ...
                : 'border border-gray-300 bg-white text-gray-700 hover:bg-gray-50 hover:shadow-sm hover:-translate-y-0.5 active:translate-y-0'
            }`}
